...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("billing_cycle_days", sa.Integer(), nullable=False, server_default=sa.text("30")),
        sa.Column("late_fee_amount", sa.Float(), nullable=False, server_default=sa.text("0.0")),
        sa.Column("grace_period_days", sa.Integer(), nullable=False, server_default=sa.text("7")),
        sa.Column("auto_disconnect_enabled", sa.Boolean(), nullable=False, server_default=sa.text("false")),
    ...
    op.create_table(
        ...
        sa.Column("email_alerts_enabled", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("outage_notifications", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("billing_notifications", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("created_at", sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
